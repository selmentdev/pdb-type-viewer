...
if ((CMAKE_GENERATOR_PLATFORM STREQUAL "x64") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "x64"))
    ...
    find_file(DIASDK_MSDIADLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin/amd64 )
elseif ((CMAKE_GENERATOR_PLATFORM STREQUAL "ARM") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" STREQUAL "ARM"))
    ...
    find_file(DIASDK_MSDIADLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin/arm )
elseif ((CMAKE_GENERATOR_PLATFORM MATCHES "ARM64.*") OR ("${CMAKE_C_COMPILER_ARCHITECTURE_ID}" MATCHES "ARM64.*"))
    ...
    find_file(DIASDK_MSDIADLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin/arm64 )
    ...
    find_file(DIASDK_MSDIADLL NAMES msdia140.dll HINTS ${DIASDK_INCLUDE_DIR}/../bin )
...
set(DIASDK_MSDIADLL ${DIASDK_MSDIADLL})
