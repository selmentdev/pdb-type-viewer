...
{
    FormAboutBox::FormAboutBox(QWidget* parent) noexcept
        : QDialog(parent)
    {
    ...
    void FormAboutBox::CreateControls() noexcept
    {
        ...
        {
            auto* version = new QLabel(QString{ "Qt Version: %1" }.arg(qVersion()));
        ...
        {
            auto* buttonPane = new QWidget(this);

            auto* okButton = new QPushButton(tr("&OK"), buttonPane);
            connect(okButton, &QPushButton::clicked, this, &FormAboutBox::close);
